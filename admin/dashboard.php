...
if (!isset($_SESSION['usuario_info_array']) or empty($_SESSION['usuario_info_array']))
  header('Location: index.php');/*validación para que no entre desde la barrar de búsqueda el archivo.php*/
?>
<!DOCTYPE html>
<html lang="en">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Bienvenido al panel de control</h1>
            <a href="pdf/procesa.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Descargar documentación</a>
          </div>
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  <div class="text-center">
                    <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;" src="../imagenes/avion.svg" alt="...">
                  </div>
