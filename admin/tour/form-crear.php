                ...
                <li class="nav-item">
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="../pasajero/pasajero.php">Pasajero</a>
                            <!--
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    ...
                    <a href="../excel/excel-tour.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Descargar excel</a>
                </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <h6 class="m-0 font-weight-bold text-primary">
                            <a href="tour.php"><img src="../../imagenes/iconos/atras.png" width="30px" height="30px"></a>Formulario
                        </h6>
                        <div class="card-body">
                                ...
                                <form class="user" method="POST" action="../acciones-tour.php" enctype="multipart/form-data">
                                    <div class="form-group row">
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            <input type="text" class="form-control form-control-user" id="exampleFirstName" placeholder="Código" name="codigo">
                                        </div>
                                        <div class="col-sm-6">
                                            <br>
                                            <label>Imagen</label>
                                            <input type="file" class="inputfile" name="foto" value="Ingrese una imagen">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            <input type="text" class="form-control form-control-user" id="exampleLastName" placeholder="Nombre" name="nombre">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            <input type="number" class="form-control form-control-user" id="exampleInputEmail" placeholder="Precio general" name="preciogeneral">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            <input type="text" class="form-control form-control-user" id="exampleInputPassword" placeholder="Hora de salida ejemplo 8 am" name="horasalida">
                                        </div>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control form-control-user" id="exampleRepeatPassword" placeholder="Hora de llegada ejemplo 10 pm" name="horallegada">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <textarea type="text" class="form-control form-control-user" id="exampleRepeatPassword" placeholder="Itinerario" name="itinerario"></textarea>
                                    </div>
                                    <div class="form-group">
                                        <textarea type="text" class="form-control form-control-user" id="exampleRepeatPassword" placeholder="Descripción general" name="general"></textarea>
                                    </div>
                                    <input type="submit" class="btn btn-primary btn-user btn-block" value="Registrar" name="accion" />
