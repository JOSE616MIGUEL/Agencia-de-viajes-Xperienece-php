...
if (isset($_GET['id']) && is_numeric($_GET['id'])) {
  ...
  $resultado = $pasajero->mostrarPorId($id);
}
  /*
  if (!$resultado)
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">
                                    <a href="pasajero.php"><img src="../../imagenes/iconos/atras.png" alt=""width="30px" height="30px"></a>Formulario
                                </h6>
                            </div>
                                    ...
                                    <form class="user" method="POST" action="../acciones-pasajero.php" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-6 mb-3 mb-sm-0">
                                                <input type="text" class="form-control form-control-user" id="" name="rut" value="<?php print $resultado['rut'] ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-sm-6 mb-3 mb-sm-0">
                                                <input type="text" class="form-control form-control-user" id="" name="nombre"value="<?php print $resultado['nombre'] ?>">
                                            </div>
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control form-control-user" id="" name="apellidos" value="<?php print $resultado['apellidos'] ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-sm-6 mb-3 mb-sm-0">
                                                <input type="text" class="form-control form-control-user" id="" name="telefono" value="<?php print $resultado['telefono'] ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-sm-6 mb-3 mb-sm-0">
                                                <input type="text" class="form-control form-control-user" id="" name="correo" value="<?php print $resultado['correo'] ?>">
                                            </div>
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control form-control-user" id="" name="direccion" value="<?php print $resultado['direccion'] ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-sm-6 mb-3 mb-sm-0">
                                                <input type="number" class="form-control form-control-user" id="" name="edad" value="<?php print $resultado['edad'] ?>">
                                            </div>
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control form-control-user" id="" name="nacionalidad" value="<?php print $resultado['nacionalidad'] ?>">
                                            </div>
                                        </div>
