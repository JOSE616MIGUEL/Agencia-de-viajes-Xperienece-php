...
<head>
  ...
  <title>Xperience chile - Contacto</title>
...
<body>
  ...
  <div class="container">
    <main>
      <form class="needs-validation" method="POST" action="controlador/acciones-pasajero-contacto.php" enctype="multipart/form-data" novalidate>
        <div class="form-row">
        <div class="form-group col-md-6">
            <h2>Ingrese sus datos</h2>
            <label for="inputEmail4">Rut</label>
            <input type="text" class="form-control border-primary"0 id="inputEmail4" name="rut" required>
          ...
          <label for="inputEmail4">Nombre</label>
            <input type="text" class="form-control border-primary" id="inputEmail4" name="nombre" required>
            <div class="valid-feedback">
              correcto!
            </div>
          </div>
          ...
          <label for="inputPassword4">Apellidos</label>
            <input type="text" class="form-control border-primary" id="inputPassword4" name="apellidos" required>
            <div class="valid-feedback">
              correcto!
            </div>
          </div>
          <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control border-primary" id="inputPassword4" name="direccion" required>
            <div class="valid-feedback">
              correcto!
            </div>
          </div>
          ...
          <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control border-primary" id="inputAddress" placeholder="+00000000000" name="telefono" required>
            <div class="valid-feedback">
              correcto!
            </div>
          </div>
          ...
          <div class="form-group col-md-6">
            ...
            <input type="email" class="form-control border-primary" id="inputAddress2" placeholder="ejemplo@ejemplo.com" name="correo" required>
            <div class="valid-feedback">
              correcto!
            </div>
          </div>
          ...
          <div class="form-group col-md-6">
            ...
            <input type="number" class="form-control border-primary" id="inputAddress2" placeholder="" name="edad" required>
            <div class="valid-feedback">
              correcto!
            </div>
          </div>
          ...
          <div class="form-group col-md-6">
            <label for="inputAddress2">Nacionalidad</label>
            <input type="text" class="form-control border-primary" id="inputAddress2" placeholder="" name="nacionalidad" required>
            <div class="valid-feedback">
              correcto!
            </div>
          </div>
        </div>
          <input type="submit" class="btn btn-primary btn-user" value="Registrar" name="accion" />
        <div class="margen" style="height: 50px;">
  ...
  <footer class="footer-distributed" id="contacto_footer">
    ...
    <div class="footer-right">
      ...
      <div class="footer-icons">
        ...
        <a href="https://www.facebook.com/profile.php?id=100084435280034&is_tour_completed=true"><i class="bx bxl-facebook-circle "></i></a>
